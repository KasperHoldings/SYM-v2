...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 02, 2016 at 08:16 AM
...
CREATE TABLE IF NOT EXISTS `aditional_covers` (
...
CREATE TABLE IF NOT EXISTS `equation_keys` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `insurance_company_insurance_type_id` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `insurance_features` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `insurance_purpose_value` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `insurance_type` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `insurance_quotation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `insurance_quotation` (`id`, `insurance_quotation_id`, `v_province`, `v_letters`, `v_number`, `title`, `first_name`, `last_name`, `email`, `mobile`, `nic`, `make`, `model`, `year`, `value`, `no_claim_bonus`, `current_insurer`, `cover_type_required`, `start_date`, `voluntary_excess`, `purpose`, `authorise_agent_repair`, `engine_no`, `chassis_no`) VALUES
(3, '09bS6o9IXlSAk072FpOXNLkQtMjOmVw2', 'PO', 'VSA', '4568', 'Mr', 'sachith', 'rodrigo', 'sachith5593@live.com', '778118805', '910930109V', '2', '16', '1927', 12112, 1, '15', 1, '2016-08-03', 2, 3, NULL, NULL, NULL),
(2, '5229BKvJN09sOewsT7fHV5wEUWywyzcZ', 'MN', 'CAS', '9875', 'Mr', 'Tharinda', 'Rodrigo', 'tharindarodrigo@gmail.com', '774479260', '910930109V', '3', '1590', '2015', 100000, 1, '15', 1, '2016-08-03', 2, 3, NULL, NULL, NULL),
(1, 'BY3xHZG-ti_0tmdkOF6n0tiYuH-dMw0K', 'ER', 'VSA', '4568', 'Mr', 'sachith', 'rodrigo', 'sachith5593@live.com', '778118805', '910930109V', '2', '16', '1926', 1000000, 1, '15', 1, '2016-08-03', 2, 3, NULL, NULL, NULL),
(4, 'orlSr86796jceV-u3eJnAbNKivWE5jFE', 'BF', 'CAR', '3487', 'Mr', 'Tharinda', 'Rodrigo', 'tharindarodrigo@gmail.com', '774479260', '910930109V', '3', '1590', '1927', 200000, 1, '15', 1, '2016-08-03', 2, 3, NULL, NULL, NULL),
(5, 'VVFYVqiV9UwAfLhnULTooNTQ_J_WceYJ', 'VB', 'VSA', '3487', 'Mr', 'Tharinda', 'Rodrigo', 'tharindarodrigo@gmail.com', '774479260', '910930109V', '2', '16', '1926', 12112, 1, '15', 1, '2016-08-03', 2, 3, NULL, NULL, NULL),
(6, 'w2xjZhe8f90U_oqCZesm35FgF9TXALvt', 'MO', 'CAS', '1202', 'Mr', 'Tharinda', 'Rodrigo', 'tharindarodrigo@gmail.com', '774479260', '910930109V', '3', '1590', '1927', 12000, 1, '15', 1, '2016-08-03', 2, 3, NULL, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `insurance_quotation_aditional_covers` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `insurance_quotation_id` varchar(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `value_added_service` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `voluntary_excess` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
